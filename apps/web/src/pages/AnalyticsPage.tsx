...
export function AnalyticsPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      {/* Breakdown charts. Fixed-height rows (gridAutoRows) + default stretch keep
          every card the same height (clean aligned grid). Each Card body scrolls
          its own overflow, so the full assignee/client lists are reachable by
